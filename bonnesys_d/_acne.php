  ...
  <section class="products">
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-lg-9 col-md-9">
          <div class="pro-title">
            <h2>BiON Acne Skin Care</h2>
            <p>BiON’s acne products achieve control of acne in over 90% of cases because of our comprehensive approach to treating the multiple causes of acne, rather than only focusing on the symptoms.<br><br>

Control in the other 10% of cases can be achieved. BiON’s acne products effectively kill Propionibacterium acnes bacteria while providing powerful anti-inflammatory benefits and work to keep follicles clear. BiON's line of acne products includes several acne cleansers and acne treatment products.</p>
          </div>
          <div class="gallery"> 
            <!-- /.Products row start ./-->
            <div class="row"> 
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/acne-inhibiting-gel.jpg" alt="">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/antibacterial-cleanser.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/bacteriorstat-cleanser.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/blackhead-whitehead.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
                  ...
                  <li>
                    <h4>Blackhead-Whitehead Controller</h4>
                  </li>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/folice-cleanse.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
                  ...
                  <li>
                    <h4>Follicle Clearing Lotion</h4>
                  </li>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/gyclolic-cleanser.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/mineral-cream-cleanser.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/moisture-complex.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
