  ...
  <section class="products">
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-lg-9 col-md-9">
          <div class="pro-title">
            <h2>BiON Mosturizers</h2>
            <p>BiON’s moisturizing products have high concentrations of nourishing and effective ingredients to keep the skin smooth, hydrated and firm. Betaglucan stimulates fibro-blast cells to produce elastin and collagen.<br>
<br>
Hydrocotyl is a powerful skin regenerative agent and antioxidant. The high concentration of essential fatty acids and lecithin further assist in re-establishing the skin’s lipid barrier function. BiON products also offer significant immune and repair stimulation.</p>
          </div>
          <div class="gallery"> 
            <!-- /.Products row start ./-->
            <div class="row"> 
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/glycolic-20.jpg" alt="">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/hydrating-body-creme.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/intense-eye.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
                  ...
                  <li>
                    <h4>Intense Eye Moisturizing Cream</h4>
                  </li>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/naturally-moist.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
                  ...
                  <li>
                    <h4>Naturally Soft Body Lotion</h4>
                  </li>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/titanium-dioxide.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/ultra-moisture-renewal.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/youthful-eyes.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
                  ...
                  <li>
                    <h4>Youthful Eyes Peptide Serum</h4>
                  </li>
