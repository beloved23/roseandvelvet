    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-lg-9 col-md-9">
          <div class="pro-title">
            <h2>BiON Cleanser</h2>
            <p>Cleansers are where it all begins for skin care and BiON gives the esthetician a wide range of products to meet every skin type and need. We use natural products that nourish and hydrate the skin to help it look and feel healthy and youthful.
          ...
          <div class="gallery"> 
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/cucumber-scrub.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/fruit-enzme.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/naturally-clean.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
                  ...
                  <li>
                    <h4>Naturally Clean Body Wash</h4>
                  </li>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/normal-skin-cleanser.jpg" alt="">
                      <div class="img-overlay-3-up pat-override"></div>
                      <div class="img-overlay-3-down pat-override"></div>
