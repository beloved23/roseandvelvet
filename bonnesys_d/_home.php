      ...
      <span class="icon-bar"></span>
                ...
                <div id="navbar-collapse-1" class="collapse navbar-collapse pull-right">
                  <ul class="nav navbar-nav">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        <li><a tabindex="-1" href="beginners"> Beginners</a></li>
                          <li><a tabindex="-1" href="intermediate">Intermediate </a></li>
                          <li><a tabindex="-1" href="advanced">Advanced</a></li>
                          </ul>
                      ...
                      <!-- Product End -->                    
                       ...
                       <li><a href="http://mynaijaskin.com">BLOG</a></li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 cp_load fadeInUp">
          <div class="hservice">
            <ul>
              ...
              <li>
                <button onClick="window.location.href='stretchmark'">Read More</button>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 cp_load fadeInUp">
          <div class="hservice">
            <ul>
              ...
              <li>
                <button onClick="window.location.href='bodydepig'">Read More</button>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 cp_load fadeInUp">
          <div class="hservice">
            <ul>
              ...
              <li>
                <button onClick="window.location.href='bodymassage'">Read More</button>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 cp_load fadeInUp">
          <div class="hservice">
            <ul>
              ...
              <li>
                <button onClick="window.location.href='slimmingtreat'">Read More</button>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 cp_load fadeInUp">
          <div class="hservice">
            <ul>
              ...
              <li>
                <button onClick="window.location.href='spa'">Read More</button>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 cp_load fadeInUp">
          <ul class="pro-box">
            ...
            <li>
              <h4><a href="acne">BiON Acne Skin Care</a></h4>
            </li>
            
            <li class="pro-footer"><a href="acne"><span class="price">view products</span></a>  </li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 cp_load fadeInUp">
          <ul class="pro-box">
            ...
            <li class="pro-footer"><a href="matureskin"><span class="price">view products</span></a>  </li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 cp_load fadeInUp">
          <ul class="pro-box">
            ...
            <li>
              <h4><a href="cleanser">BiON Cleanser</a></h4>
            </li>
            
            <li class="pro-footer"><a href="cleanser"><span class="price">view products</span></a>  </li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 cp_load fadeInUp">
          <ul class="pro-box">
            ...
            <li>
              <h4><a href="moisturizer">BiON Mosturizers</a></h4>
            </li>
            
            <li class="pro-footer"><a href="moisturizer"><span class="price">view products</span></a> </li>
          </ul>
        </div>
      </div>
    </div>
...
<section id="footer">
    ...
    <script>(function(d, s, id) {
            ...
            js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.4&appId=252386034803451";
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6">
          <h3>Facebook</h3>
            <div class="fb-page" data-href="https://www.facebook.com/roseandvelvet" data-height="250" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/roseandvelvet"><a href="https://www.facebook.com/roseandvelvet">Rose and Velvet</a></blockquote></div></div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6">
          <h3>OPENING HOURS</h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
          <h3>Tweets</h3>
          <div>
              <a class="twitter-timeline" href="https://twitter.com/roseandvelvet" data-widget-id="632164936781852672">Tweets by @roseandvelvet</a>
