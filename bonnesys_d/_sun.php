  ...
  <section class="products">
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-lg-9 col-md-9">
          <div class="pro-title">
            <h2>BiON Titanium Dioxide Sunscreen SPF 30</h2>
            <p>This award winning sunscreen provides UVA and UVB protection. With SPF 30, BiON’s broad spectrum physical sunscreen provides maximum antioxidant and anti-carcinogenic benefits. BiON uses highly micronized particles that are dispersed evenly on the skin and provides effective protection from harmful rays without leaving a white cast to the skin.</p>
          </div>
          <div class="gallery"> 
            <!-- /.Products row start ./-->
            <div class="row"> 
            ...
            <div class="row"> 
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 cp_load fadeInUp">
                <ul class="pro-box">
                  <li class="pro">
                    <div class="block-image"> <img class="img-responsive" src="images/sun-prod.jpg" alt="">
